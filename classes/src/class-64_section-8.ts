...
class CourseDetail {
    title: string;
    subtitle: string;
    creationDate: Date; // nesse caso estamos criando um atributo que é do tipo classe Date dentro da classe Course
...
// Criando uma nova instância da classe
const courseDetail2 = new CourseDetail2(
    "TypeScript Bootcamp 2",
    "Learn the language fundamentals, build practical projects",
    new Date(2011, 1, 1)
);
