/*
    ...
    estáticos.
*/
var Course71 = /** @class */ (function () {
    function Course71(_title, subtitle, creationDate
    /*
        MUITO CUIDADO!
    ...
    */
    ...
    // Método estático
    Course71.printTitle = function (course) {
    ...
    Object.defineProperty(Course71.prototype, "title", {
        // Métodos
        get: function () {
            return this._title;
        },
    ...
    Course71.TOTAL_COURSES = 0; // propriedade estática e tem por padrão toda as letras em maiúsculo
    ...
    */
    ...
    Course71.TYPESCRIPT_TITLE = "TypeScript Bootcamp";
    return Course71;
}());
Course71.TOTAL_COURSES;
var typescript71 = new Course71(Course71.TYPESCRIPT_TITLE);
/*
